...
class WaitingFriendRequestAdapter(
    val mContext: Context,
    val mRequests: List<FriendRequest>,
    var mCallback: RequestClickListener
) : RecyclerView.Adapter<WaitingFriendRequestAdapter.FriendRequestViewHolder>() {
    ...
    inner class FriendRequestViewHolder(
        ...
        init {
            itemView.setOnClickListener {
                mCallback.onClick(mRequests.get(adapterPosition).sender)
            }
